...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar changeHandler_1 = __importDefault(__webpack_require__(/*! ./changeHandler */ \"./src/changeHandler.ts\"));\r\nfunction default_1(data) {\r\n    var changeHandler = changeHandler_1.default.create();\r\n    return makeReactive(data, changeHandler);\r\n}\r\nexports.default = default_1;\r\nfunction makeReactive(data, changeHandler, prefix) {\r\n    if (prefix === void 0) { prefix = \"\"; }\r\n    Object.defineProperty(data, \"_reactive\", { value: { path: prefix, changeHandler: changeHandler }, enumerable: false, writable: true });\r\n    return new Proxy(data, {\r\n        set: createSetHandler(changeHandler, prefix),\r\n        get: createGetHandler(changeHandler, prefix),\r\n        deleteProperty: createDeleteHandler(changeHandler, prefix)\r\n    });\r\n}\r\nfunction createSetHandler(changeHandler, prefix) {\r\n    return function (target, prop, newValue) {\r\n        var path = appendPrefix(prefix, prop);\r\n        var oldValue = target[prop];\r\n        var reactiveNewValue = ensureReactive(newValue, changeHandler, path);\r\n        var result = Reflect.set(target, prop, reactiveNewValue);\r\n        changeHandler.dataChanged(path, reactiveNewValue, oldValue);\r\n        return result;\r\n    };\r\n}\r\nfunction createGetHandler(changeHandler, prefix) {\r\n    return function (target, prop, receiver) {\r\n        var result = Reflect.get(target, prop);\r\n        return ensureReactive(result, changeHandler, appendPrefix(prefix, prop));\r\n    };\r\n}\r\nfunction ensureReactive(data, changeHandler, path) {\r\n    if (typeof data === 'object' && data._reactive !== true) {\r\n        return makeReactive(data, changeHandler, path);\r\n    }\r\n    return data;\r\n}\r\nfunction createDeleteHandler(changeHandler, prefix) {\r\n    return function (target, prop) {\r\n        var result = Reflect.deleteProperty(target, prop);\r\n        return result;\r\n    };\r\n}\r\nfunction appendPrefix(prefix, addition) {\r\n    if (prefix === \"\")\r\n        return addition;\r\n    return prefix + \".\" + addition;\r\n}\r\n\n\n//# sourceURL=webpack://appletart/./src/makeReactive.ts?");
...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar makeReactive_1 = __importDefault(__webpack_require__(/*! ./makeReactive */ \"./src/makeReactive.ts\"));\r\nvar _listeners = {};\r\nvar _globalState = null;\r\nfunction createGlobalStore(state) {\r\n    _globalState = makeReactive_1.default(state);\r\n    return _globalState;\r\n}\r\nexports.createGlobalStore = createGlobalStore;\r\nfunction createStore(state) {\r\n    return makeReactive_1.default(state);\r\n}\r\nexports.createStore = createStore;\r\nfunction getGlobalState() {\r\n    return _globalState;\r\n}\r\nexports.getGlobalState = getGlobalState;\r\nfunction addListener(path, callback) {\r\n    if (_listeners[path] == null) {\r\n        _listeners[path] = [callback];\r\n    }\r\n    else {\r\n        _listeners[path].push(callback);\r\n    }\r\n}\r\nexports.addListener = addListener;\r\nexports.default = {\r\n    createStore: createStore,\r\n    addListener: addListener,\r\n    getGlobalState: getGlobalState\r\n};\r\n\n\n//# sourceURL=webpack://appletart/./src/store.ts?");
